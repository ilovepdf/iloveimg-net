...
namespace iLoveIMG.Tests
{
    public abstract partial class BaseTest
    {
        ...
        protected iLoveImgApi Api { get; private set; }

        protected iLoveImgTask Task { get; set; }
        ...
        {
            Api = new iLoveImgApi(Settings.WrongPublicKey, Settings.WrongSecretKey);
        }

        protected void InitApiWithRightCredentials()
        {
            Api = new iLoveImgApi(Settings.RightPublicKey, Settings.RightSecretKey);
        }
        ...
        protected void AddFile(String addedFileName, String originalFileName, iLoveIMG.Model.Enums.Rotate rotation,
